...
from mne import EpochsArray, EvokedArray, pick_info, rename_channels
...
_data_labels = [
    ...
    "MRzaA", "MRxaA", "MRyA", "MCzA", "MRyaA", "MCzaA", "MCyA", "GzxA", "MCyaA", "A104",
    "SA1", "A241", "MCxA", "A138", "MCxaA", "A214", "SA2", "SA3", "A71", "A26", "A93",
    "A39", "A125", "A20", "A65", "A9", "A8", "A95", "A114", "A175", "A16", "A228",
    "A35", "A191", "A37", "A170", "A207", "A112", "A224", "A82", "A238", "A202", "A220",
    "A28", "A239", "A13", "A165", "A204", "A233", "A98", "A25", "A70", "A72", "A11",
    "A47", "A160", "A64", "A3", "A177", "A63", "A155", "A10", "A127", "A67", "A115",
    "A247", "A174", "A194", "A5", "A242", "A176", "A78", "A168", "A31", "A223", "A245",
    "A219", "A12", "A186", "A105", "A222", "A76", "A50", "A188", "A231", "A45", "A180",
    "A99", "A234", "A215", "A235", "A181", "A38", "A230", "A91", "A212", "A24", "A66",
    "A42", "A96", "A57", "A86", "A56", "A116", "A151", "A141", "A120", "A189", "A80",
    "A210", "A143", "A113", "A27", "A137", "A135", "A167", "A75", "A240", "A206",
    "A107", "A130", "A100", "A43", "A200", "A102", "A132", "A183", "A199", "A122",
    "A19", "A62", "A21", "A229", "A84", "A213", "A55", "A32", "A85", "A146", "A58",
    "A60", "GyyA", "A88", "A79", "GzyA", "GxxA", "A169", "A54", "GyxA", "A203", "A145",
    "A103", "A163", "A139", "A49", "A166", "A156", "A128", "A68", "A159", "A236",
    "A161", "A121", "A4", "A61", "A6", "A126", "A14", "A94", "A15", "A193", "A150",
    "A227", "A59", "A36", "A225", "A195", "A30", "A109", "A172", "A108", "A81", "A171",
    "A218", "A173", "A201", "A74", "A29", "A164", "A205", "A232", "A69", "A157", "A97",
    "A217", "A101", "A124", "A40", "A123", "A153", "A178", "A1", "A179", "A33", "A147",
    "A117", "A148", "A87", "A89", "A243", "A119", "A52", "A142", "A211", "A190", "A53",
    "A192", "A73", "A226", "A136", "A184", "A51", "A237", "A77", "A129", "A131", "A198",
    "A197", "A182", "A46", "A92", "A41", "A90", "A7", "A23", "A83", "A154", "A34",
    "A17", "A18", "A248", "A149", "A118", "A208", "A152", "A140", "A144", "A209",
    "A110", "A111", "A244", "A185", "A246", "A162", "A106", "A187", "A48", "A221",
    "A196", "A133", "A158", "A44", "A134", "A216",
    "UACurrent", "ECG+", "VEOG+", "HEOG+", "EMG_LF", "EMG_LH", "ECG-", "VEOG-", "HEOG-",
    "EMG_RF", "EMG_RH",
]
# fmt: on
...
def _check_infos_trans(infos):
    ...
    common_chs = [
        [c["chs"][c["ch_names"].index(ch)] for ch in common_channels] for c in infos
    ]
    ...
    cts = [
        np.array([linalg.inv(_loc_to_coil_trans(c["loc"])).dot(t) for c in cc])
...
def read_epochs(
    ...
    epochs = _read_epochs(
        epochs_mat_fname=epochs_mat_fname,
        info=info,
        return_fixations_motor=return_fixations_motor,
    )
    if data_type == "task_motor":
        epochs.set_channel_types({ch: "emg" for ch in epochs.ch_names if "EMG" in ch})
    return epochs
...
def _parse_annotations_segments(segment_strings):
    ...
    for entry in split:
        ...
        val = np.array(
            [
                k
                for k in ["".join([c for c in e if c.isdigit()]) for e in rest.split()]
                if k.isdigit()
            ],
            dtype=int,
        )
...
def read_annot(subject, data_type, run_index=0, hcp_path=op.curdir):
    ...
    segments_fname = [k for k in bads_files if k.endswith("baddata_badsegments.txt")][0]
    bads_fname = [k for k in bads_files if k.endswith("baddata_badchannels.txt")][0]
...
def _read_evoked(fname, sensor_mode, info, kind):
    ...
    out = list()
    comment = (
        "_".join(fname.split("/")[-1].split("_")[2:])
        .replace(".mat", "")
        .replace("_eravg_", "_")
        .replace("[", "")
        .replace("]", "")
